...
class Tool
{
	...
	public function send_sms($mobile, $message)
	{
		...
		curl_setopt($ch, CURLOPT_HTTPHEADER, array('Authorization: Basic dmlmb3RlYzpWS1lkdURuZA=='));
	...
	public function send_mail($from, $from_title, $to, $to_title, $subject, $body)
	{
		if($from == "")
		{
			$from = "no-reply@vidu.vn";
		}
		
		$host = "pro53.emailserver.vn";
		$username = "no-reply@vidu.vn"; //no-reply@itada.com.vn
	...
	public function image_resize($file, $max_width, $max_height, $save_file) 
	{
		...
		switch ($image_type)
		{
			...
			case 3: imagepng($tmp, $save_file, 9); break; // no compression
			default: echo ''; break;
		}
