...
$sql = "SELECT d1.id, d1.receipt_no, d1.receipt_date, d1.description FROM ".$table_name." d1 WHERE d1.status =0 AND d1.type ='STOCKIN' AND d1.company_id='".$appSession->getConfig()->getProperty("company_id")."'";
if($search != "")
{
