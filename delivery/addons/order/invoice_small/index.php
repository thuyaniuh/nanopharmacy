...
<tr>
 ...
 <tr >
  <td align="left" style="border:none;border-bottom:solid #999999 1.0pt;"  >
S&#7842;N PH&#7848;M </td>
	 <td colspan="2" align="right"  nowrap="nowrap" style="border:none;border-bottom:solid #999999 1.0pt;" >TH&Agrave;NH TI&#7872;N </td>
     </tr>
 <?php
 $subTotal = 0;
 $no= 0;
 ...
 <tr >
  <td colspan=3 >
  <?php echo $no;?>. <?php echo $product_name;?> (<?php echo $attribute_name;?> - <?php echo $type_name;?>)   <?php echo $unit_name;?>   </td>
  </tr>
  <tr >
  <td colspan="2" align="right" >
  <?php echo $appSession->getFormats()->getDOUBLE()->format($quantity);?> x <?php echo $appSession->getCurrency()->format($company_currency_id, $unit_price);?> &nbsp;&nbsp;&nbsp;</td>
  <td width="30" align="right"  >
   <?php echo $appSession->getCurrency()->format($company_currency_id, $amount);?>  </td>
	 ...
	 <tr >
  <td colspan=3 >
  &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $product_name;?> (<?php echo $attribute_name;?> - <?php echo $type_name;?>)   <?php echo $unit_name;?>   </td>
  </tr>
  <tr >
  <td colspan="2" align="right" >
  <?php echo $appSession->getFormats()->getDOUBLE()->format($quantity);?> x <?php echo $appSession->getCurrency()->format($company_currency_id, $unit_price);?> &nbsp;&nbsp;&nbsp;</td>
 ...
 <tr>
  <td colspan="2" style="border:none;border-top:solid #999999 1.0pt;"><strong><br>
  T&#7892;NG</strong></td>
...
?>
 <tr>
   <td colspan="2"><strong>PH&Iacute;</strong></td>
   <td align="right" >
...
?>
 <tr>
   <td colspan="2"><strong>THU&#7870;</strong></td>
   <td align="right" >
 ...
 ?>
  <tr>
   <td colspan="2" ><?php echo $payment_name;?></td>
  <td align="right" >
...
<tr>
  <td><table width="100%" border="0">
    <tr>
      <td colspan="3" style="text-align:right"><em>Ng&agrave;y <?php echo $dd;?> th&aacute;ng <?php echo $mm;?> n&#259;m <?php echo $yy;?></em></td>
      </tr>
    <tr>
      <td width="20%" align="center" nowrap><strong>KCS</strong></td>
      <td width="24%" align="center" nowrap><strong>Kh&aacute;ch h&agrave;ng </strong></td>
      <td width="56%" align="center" nowrap><strong>Thu ng&acirc;n </strong></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
