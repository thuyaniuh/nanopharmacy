...
.input{padding:8px;display:block;border:1px solid #ccc;width:100%}
.select{padding:9px 0;width:100%;border:1px solid #ccc}
...
.bar-block .dropdown-hover .button,.bar-block .dropdown-click .button{width:100%;text-align:left;padding:8px 8px}
