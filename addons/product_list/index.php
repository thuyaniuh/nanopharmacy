									...
									<div class="col-4">
										<div class="form-group wow">
											...
											<select type="text" id="editcategory_id" class="form-control">
												...
												?>
													<option value="<?php echo $dt_category->getString($i, "id"); ?>" <?php if ($category_id == $dt_category->getString($i, "id")) {
																														echo " selected";
																													} ?>><?php echo $dt_category->getString($i, "name"); ?></option>
												<?php
												}
												?>
											</select>
									...
									<div class="col-4">
										<div class="form-group wow">
											...
											<select type="text" id="editunit_id" class="form-control">
												...
												?>
													<option value="<?php echo $dt_unit->getString($i, "id"); ?>" <?php if ($unit_id == $dt_unit->getString($i, "id")) {
																													echo " selected";
																												} ?>><?php echo $dt_unit->getString($i, "name"); ?></option>
												<?php
												}
												?>
											</select>
