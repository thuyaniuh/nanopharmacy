...
<?php } ?>
										...
										<?php for ($i = 0; $i < count($photos); $i++) {
                                            ...
                                            <div>
                                                <div class="sidebar-image">
                                                    <img src="<?php echo URL; ?>document/?id=<?php echo $document_id; ?>&h=150"
                    ...
                    <?php } ?> <span
                                ...
                                <div class="buy-box">
                                    <a href="<?php echo URL;?>wishlist/?price_id=<?php echo $product_price_id;?>" class="notifi-wishlist">
                                        <i data-feather="heart"></i>
                                        <span><?php echo $appSession->getLang()->find("Add To Wishlist");?></span>
                                    </a>

                                    <a href="<?php echo URL;?>compare/?price_id=<?php echo $product_price_id;?>">
