            ...
            <div class="row">
                <div class="col-xxl-9 col-xl-8 col-lg-7 wow fadeInUp">
                    <div class="row g-4">
                                            ...
                                            ?>
                                                <div>
                                                    <div class="slider-image">
                                                        <img src="<?php echo URL; ?>document/?id=<?php echo $document_id; ?>" id="img-1" data-zoom-image="<?php echo URL; ?>document/?id=<?php echo $document_id; ?>" class="img-fluid image_zoom_cls-0 blur-up lazyload" alt="<?php echo $name; ?>">
                                                    </div>
                                                </div>
                                            <?php } ?>
                                            ...
                                            ?>
                                                <div>
                                                    <div class="sidebar-image">
                                                        <img src="<?php echo URL; ?>document/?id=<?php echo $document_id; ?>" class="img-fluid blur-up lazyload" alt="<?php echo $name; ?>">
                                                    </div>
                                                </div>
                                            <?php
                                            }
                            ...
                            <div class="right-box-contain">
                                ...
                                <div class="price-rating">
                                    <h3 class="theme-color price"><?php echo $appSession->getCurrency()->format($product_currency_id, $product_unit_price); ?>/ <?php echo $unit_name ?>
                                        ...
                                        <?php } ?> <span class="offer theme-color">(8% off)</span>
                                    </h3>
                                ...
                                <div class="note-box product-packege">
                                    <div class="cart_qty qty-box product-qty">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control input-number qty-input" type="text" name="quantity" value="0" id="quantity">
                                    ...
                                    <button onclick="addingProduct('card');" class="btn btn-md bg-dark cart-button text-white w-100"><?php echo $appSession->getLang()->find("Add To Cart"); ?></button>
                                </div>
                        ...
                        $sql = "SELECT d1.id, d1.name, d1.description, d1.content, d1.category_id, d2.name FROM res_rel d LEFT OUTER JOIN post d1 ON(d.res_id = d1.id) LEFT OUTER JOIN post_category d2 ON(d1.category_id = d2.id) WHERE d.status =0 AND d1.status =0 AND d.rel_id='" . $product_id . "' AND d1.status =0 AND d1.publish = 1";
                        ...
                        <div class="col-12">
                            <div class="product-section-box">
                                <ul class="nav nav-tabs custom-nav" id="myTab" role="tablist">
                                    ...
                                    ?>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link <?php if ($i == 0) { ?> active <?php } ?>" id="description-tab" data-bs-toggle="tab" data-bs-target="#tb<?php echo $i; ?>" type="button" role="tab" aria-controls="tb<?php echo $i; ?>" aria-selected="true"><?php echo $category_name; ?></button>
                                        </li>
                                    <?php
                                    }
                                    ?>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link <?php if (count($post_categories) == 0) { ?> active <?php } ?>" id="description-tab" data-bs-toggle="tab" data-bs-target="#tbreview" type="button" role="tab" aria-controls="tbreview" aria-selected="true"><?php echo $appSession->getLang()->find("Reviews"); ?><span id="reviewCount"></span></button>
                                    </li>
                                ...
                                <div class="tab-content custom-tab" id="myTabContent">
                                    ...
                                    ?>
                                        <div class="tab-pane fade show <?php if ($i == 0) { ?> active <?php } ?>" id="tb<?php echo $i; ?>" role="tabpanel" aria-labelledby="description-tab">
                                    ...
                                    ?>
                                    <div class="tab-pane fade show <?php if (count($post_categories) == 0) { ?> active <?php } ?>" id="tbreview" role="tabpanel" aria-labelledby="description-tab">
                                        <div class="product-description">
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-floating theme-form-floating">
                                                            <textarea class="form-control" placeholder="Leave a comment here" id="review_comment" style="height: 150px"></textarea>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="address-contact">
                                            ...
                                            <h5><?php echo $appSession->getLang()->find("Follow Us"); ?>: <span class="text-content">
                                                    <div class="vendor-list">
                                                ...
                                                <li>
                                                    <div class="offer-product">
                                                        <a href="product-left-thumbnail.html" class="offer-image">
                                                            <img src="<?php echo URL; ?>/document/?id=<?php echo $document_id; ?>&h=95" class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                ...
                                <div class="ratio_156 pt-25">
                                    <div class="home-contain">
                                        ...
                                        <div class="home-detail p-top-left home-p-medium">
                                            <div>
                                                <?php echo $content; ?>
                                                <button onclick="location.href = '<?php echo URL; ?><?php echo  $appSession->getTool()->validUrl($name); ?>/g-<?php echo $code; ?>';" class="btn btn-animation btn-md fw-bold mend-auto">Shop Now <i class="fa-solid fa-arrow-right icon"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="<?php echo URL; ?><?php echo  $appSession->getTool()->validUrl($name); ?>/p-<?php echo $price_id; ?>">
                                                    <img src="<?php echo URL; ?>document/?id=<?php echo $document_id; ?>&w=145" class="img-fluid blur-up lazyload" alt="">
                                                </a>
