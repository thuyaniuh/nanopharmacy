...
<body class="bg-effect">
  ...
  <header class="pb-md-4 pb-0">
    <div class="header-top" style="background-color: #1496BA">
      <div class="container">
        <div class="row">
              ...
              <li class="right-nav-list">
                <div class="dropdown theme-form-select">
                  <button class="btn dropdown-toggle" type="button" id="select-language" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo URL; ?>/assets/images/flags/<?php echo $lang_id; ?>.png" class="img-fluid blur-up lazyload" alt="">
                    <span><?php
                          for ($i = 0; $i < count($langList); $i++) {
                    ...
                    ?>
                      <li>
                        <a class="dropdown-item" href="<?php echo URL; ?>lang/<?php echo $langList[$i]; ?>/<?php echo $page; ?>/<?php echo $page_id; ?>">
                          <img src="<?php echo URL; ?>/assets/images/flags/<?php echo $langList[$i]; ?>.png" class="img-fluid blur-up lazyload" alt="">
    ...
    <div class="header-top" style="background-color: white">
      <div class="container">
        <div class="row">
          ...
          <div class="col-xxl-3 col-lg-9 d-lg-block d-none">
            <div class="header-offer">
              <div class="notification-slider">
        ...
        <div class="row">
          <div class="col-12">
            <div class="navbar-top">
              ...
              <div class="middle-box" style="flex: 1;margin: 0 70px;">
            ...
            <div class="main-nav navbar navbar-expand-xl navbar-light navbar-sticky">
              <div class="offcanvas offcanvas-collapse order-xl-2" id="primaryMenu">
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav" style="text-transform: uppercase; font-weight: bolder; padding-left: 0; margin-bottom: 0;">
                    ...
                    <li class="nav-item dropdown" style="margin-right: 1rem;">
                      ...
                      <ul class="dropdown-menu" style="padding: 0; margin: 0;">
                        <li><a class="dropdown-item" href="<?php echo URL; ?>about" style="padding: 0.5rem 1rem;"><?php echo $appSession->getLang()->find("Company profile"); ?></a></li>
                        <li><a class="dropdown-item" href="<?php echo URL; ?>contact" style="padding: 0.5rem 1rem;"><?php echo $appSession->getLang()->find("Contact"); ?></a></li>
                      </ul>
                    </li>
                    <li class="nav-item" style="margin-right: 1rem;">
                      <a href="" class="nav-link">CHUYÊN GIA TƯ VẤN</a>
                    </li>
                    <li class="nav-item dropdown" style="margin-right: 1rem;">
                      <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-bs-toggle="dropdown"><?php echo $appSession->getLang()->find("Product"); ?></a>
                      <ul class="dropdown-menu" style="padding: 20px; margin: 0;">
                        <?php
                        ...
                        ?>
                          ...
                          if ($hasItem == true) {
                          ?>
                            <li class="sub-dropdown-hover" style="margin-right: 1rem;">
                              ...
                              ?>
                                ...
                                if ($hasItem == true) {
                                ?>
                                  <ul class="sub-menu" style="padding: 0.5rem 1rem;">
                                    <?php
                                    for ($n2 = 0; $n2 < $dt_category->getRowCount(); $n2++) {
                                      $parent_id3 = $dt_category->getString($n2, "parent_id");
                                      if ($parent_id3 != $parent_id1) {
                ...
                ?>
                  ...
                  <li class="nav-item dropdown" style="margin-right: 1rem;">
                    ...
                    <ul class="dropdown-menu" style="padding: 0; margin: 0;">
                      <li><a class="dropdown-item" href="<?php echo URL; ?>sale_payment" style="padding: 0.5rem 1rem;">Chính sách thanh toán</a></li>
                      <li><a class="dropdown-item" href="<?php echo URL; ?>sale_shipping" style="padding: 0.5rem 1rem;">Chính sách vận chuyển</a></li>
                      <li><a class="dropdown-item" href="<?php echo URL; ?>sale_refund" style="padding: 0.5rem 1rem;">Chính sách kiểm hàng và hủy, đổi trả</a></li>
                      <li><a class="dropdown-item" href="<?php echo URL; ?>sale_policy" style="padding: 0.5rem 1rem;">Chính sách bảo mật thông tin</a></li>
                    </ul>
                  </li>
                    ...
                    <li class="nav-item dropdown" style="margin-right: 1rem;">
                      ...
                      <ul class="dropdown-menu" style="padding: 0; margin: 0;">
                        <?php for ($i = 0; $i < count($post_category); $i++) { ?>
                          <li style="margin-bottom: 0.5rem;"><a class="dropdown-item" href="<?php echo URL; ?>blog/<?php echo $appSession->getTool()->validUrl($post_category[$i][1]); ?>/<?php echo $post_category[$i][0]; ?>"><?php echo $post_category[$i][1]; ?></a></li>
                        <?php } ?>
                      </ul>
                    </li>
                  <?php } ?>
        ...
        <div class="col-2" style="display: flex; align-items: center;">
          <div class="header-nav-right">
            <a href="<?php echo URL; ?>shop_become/" class="btn" style="color: red; border-radius: 5px;">
              <span><?php echo $appSession->getLang()->find("HOT SALE"); ?></span><span class="badge" style="background-color: red; color: white;margin-left:0.5rem ;padding: 0.5rem 1rem; border-radius: 5px; font-weight: bold;">SALE</span>
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="main-footer section-b-space section-t-space" style="border-top: 0px;">
        <div class="row">
          <div class="col-xl-4 col-lg-4 col-sm-6">
            <b>
              <p>Đăng kí để nhận ưu đãi sớm nhất</p>
            </b>
            <p style="color:#808183;">Đăng kí ngay để nhận thông tin cập nhật mới nhất về khuyến mãi và phiếu giảm giá. Đừng lo, chúng tôi cam kết bảo mật
              và chỉ gửi bạn những thông tin ưu đãi bổ ích</p>
          </div>
          <div class="col-xl-4 col-lg-4 col-sm-0"></div>
          <div class="col-xl-4 col-lg-4 col-sm-6">
            <div class="search-box">
              <div class="input-group">
                <input type="email" class="form-control email-input" placeholder="Hãy điền email của bạn">
                <button class="btn" style='background-color: #1496BA; color:white'>
                  GỬI
                </button>
              </div>
            </div>
            <br>
            <p style=" color:#808183;">Bằng cách đăng ký, bạn đồng ý với chúng tôi <a href="" style=" color:#1496BA">Điều khoản & Điều kiện</a> và <a href="" style=" color:#1496BA">Chính sách quyền riêng tư & Cookie</a></p>
          </div>
        </div>
      </div>
      <hr>
      <div class="main-footer section-b-space section-t-space" style="border-top: 0px;">
        <div class="row g-md-4 g-3">
          <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="footer-logo">
              <div class="footer-title">
                <b>
                  <h5>CÔNG TY CỔ PHẦN TẬP ĐOÀN DƯỢC NANO</h5>
                </b>
              </div>
              <br>
              ...
              <div class="footer-logo-contain">
                ...
                <div class="logo-contain" style="width:80%">
                  <img src="<?php echo URL; ?>assets/images/logo-hongsam-999-300x114.png" alt="" style="width:80%">
                </div>
              </div>
            </div>
          </div>
          <div class="col-xl-4 col-sm-3">
            <div class="footer-title">
              <h5 style="text-transform: uppercase;"><?php echo $appSession->getLang()->find("Policy"); ?></h5>
            </div>
          ...
          <div class="col-xl-2 col-sm-3">
            <div class="footer-title">
              <h5 style="text-transform: uppercase;"><?php echo $appSession->getLang()->find("Useful Links"); ?></h5>
            </div>
            <div class="footer-contain">
              <ul>
                ...
                <li>
                  <a href="<?php echo URL; ?>contact" class="text-content"><?php echo $appSession->getLang()->find("Contact"); ?></a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
            <div class="footer-title">
              <h5 style="text-transform: uppercase;"><?php echo $appSession->getLang()->find("Categories"); ?></h5>
            </div>
  ...
  <!-- Bg overlay End -->
  <div class="modal fade theme-modal view-modal" id="pnFullDialog" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <script src="<?php echo URL; ?>assets/js/price-range.js"></script>
