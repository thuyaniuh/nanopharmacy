    ...
    <div class="row">
      ...
      <div class="col-custome-9">
        ...
        <div class="row g-sm-4 g-3 row-cols-xxl-4 row-cols-xl-3 row-cols-lg-2 row-cols-md-3 row-cols-2 product-list-section">
		  ...
		  $dt_product = $appSession->getTool()->selectDistinctTable($productList, [
		"id", "code", "name", "document_id", "name_lg"
		  ]);
          for ($i = 0; $i < $dt_product->getRowCount(); $i++) {
            $wowDelay += 0.05;

            $product_id = $dt_product->getString($i, "id");
            $code = $dt_product->getString($i, "code");
			...
			$unit_in_stock = 0;
			$priceList = [];
			for($j =0; $j<$productList->getRowCount(); $j++){
				if($productList->getString($j, "id") == $product_id){
					$priceList[count($priceList)] = $productList->getFloat($j, "unit_price");
				}
			}
			sort($priceList);
			if(count($priceList)>0){
				$min_price = $priceList[0];
				$max_price = $priceList[count($priceList)-1];
			}
						...
						<div class="product-image bg-white">
							...
							<ul class="product-option">
								 <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
									<a href="javascript:openPopup('<?php echo URL;?>addons/product_popup/?id=<?php echo $code;?>')">
										<i data-feather="eye"></i>
									</a>
								</li>

								<li data-bs-toggle="tooltip" data-bs-placement="top" title="Compare">
									<a href="<?php echo URL;?>compare/?price_id=<?php echo $code;?>">
										<i data-feather="refresh-cw"></i>
									</a>
								</li>

								<li data-bs-toggle="tooltip" data-bs-placement="top" title="Wishlist">
									<a href="<?php echo URL;?>wishlist/?price_id=<?php echo $code;?>" class="notifi-wishlist">
								...
								<li data-bs-toggle="tooltip" data-bs-placement="top" title="seller">
									<a href="<?php echo URL;?>seller_detail/?price_id=<?php echo $code;?>" class="notifi-wishlist">
					...
					<div class="product-footer ">
						<div class="product-detail">
							...
							<h5 class="sold text-content">
								<span class="theme-color price"><?php echo $appSession->getCurrency()->format($currency_id, $min_price);?>
								- <?php echo $appSession->getCurrency()->format($currency_id, $max_price);?>
							</span>
