                    ...
                    <div class="breadscrumb-contain">
                        ...
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Đối tác tư vấn</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xxl-7">
                    <div class="seller-title h-100 d-flex align-items-center">
                        <div>
                            <h2>TRỞ THÀNH ĐỐI TÁC TƯ VẤN TRÊN SIEUTHITPCN.VN</h2>
                            <p>Khởi nghiệp kinh doanh online luôn đối mặt với nhiều khó khăn. Một trong những thách thức lớn nhất là thiếu kinh nghiệm và kiến thức kinh doanh. Nhiều người lo sợ rủi ro khi phải bỏ vốn nhập hàng mà chưa chắc chắn về khả năng tiêu thụ. Họ cũng thường gặp khó khăn trong việc sử dụng các công cụ marketing hiện đại để tiếp cận khách hàng hiệu quả. Bên cạnh đó, việc tìm nguồn hàng chất lượng với chiết khấu tốt không phải là điều dễ dàng đối với những người mới bắt đầu. Thêm vào đó, việc không có nhiều thời gian để quản lý toàn bộ công việc vận hành như quản lý hàng hóa, vận chuyển, tư vấn, và bán hàng càng làm cho quá trình khởi nghiệp trở nên phức tạp hơn. SIEUTHITPCN.VN là giải pháp giúp bạn vượt qua những khó khăn này, giúp bạn bắt đầu công việc kinh doanh online một cách dễ dàng và hiệu quả hơn.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="become-service section-b-space">
        <div class="container-fluid-lg">
            <div class="seller-title mb-5">
                <h2>TẠI SAO PHẢI PHẢI KINH DOANH TRÊN SIEUTHITPCN.VN ?</h2>
            </div>
            ...
            <div class="row">
                <div class="col-xxl-3">
                    <div class="service-box">
                        ...
                        <div class="service-detail">
                            <h4>Giải pháp kinh doanh đơn giản cho mọi người</h4>
                            <p>SIEUTHITPCN.VN là mô hình kinh doanh giảm thiểu nhiều rủi ro cho cá nhân kinh doanh. Khi có khách hàng đặt sản phẩm, người bán chỉ cần lên đơn ngay trên web và đối tác sản phẩm sẽ giao thẳng đến tay người mua.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-3">
                    <div class="service-box">
                        ...
                        <div class="service-detail">
                            <h4>Giảm thiểu gánh nặng chi phí</h4>
                            <p>Đối tác kinh doanh của SIEUTHITPCN.VN không lo cần phải lo nhập hàng, lưu trữ sản phẩm, đóng gói, do đó bạn sẽ giảm được nhiều chi phí như vốn nhập hàng, chi phí bao bì, kho bãi.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-3">
                    <div class="service-box">
                        ...
                        <div class="service-detail">
                            ...
                            <p>Siêu ứng dụng web hỗ trợ đối tác kinh doanh trong quản lý công việc kinh doanh như lựa chọn sản phẩm, cập nhật khuyến mãi, lên đơn và quản lý doanh thu,...</p>
                        </div>
                    </div>
                </div>
			...
			c16.277-5.525,51.243-15.019,101.995-16.213V309.33z" />
                        ...
                        <div class="service-detail">
                            <h4>Được đào tạo các kỹ năng bán hàng</h4>
                            <p>Khi trở thành đối tác kinh doanh của SIEUTHITPCN.VN, bạn sẽ được đào tạo các kỹ năng bán hàng, kiến thức về sản phẩm từ các đối tác kinh doanh dày dặn kinh nghiệm và các nhà phát triển sản phẩm (nhà cung cấp).</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="business-box">
                            <div>
                                ...
                                <div class="business-detail">
                                    <h4>Kinh doanh mọi lúc, mọi nơi</h4>
                                    <p>Nhờ sự hỗ trợ của ứng dụng siêu web, bạn có thể tư vấn, lên đơn và chăm sóc cho khách hàng ở bất kỳ lúc nào và bất cứ ở đâu trên chính chiếc điện thoại của mình.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-4">
                        <div class="business-box">
                            <div>
                                ...
                                <div class="business-detail">
                                    <h4>Đa dạng sản phẩm chất lượng</h4>
                                    <p>SIEUTHITPCN.VN có hơn 2000 sản phẩm ngách bao gồm nhiều ngành hàng như Làm đẹp, Sức khỏe là những sản phẩm uy tín và chất lượng cao qua nhiều năm xây dựng nhằm mang những sản phẩm tốt nhất đến tay người tiêu dùng.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-4">
                        <div class="business-box">
                            <div>
                                ...
                                <div class="business-detail">
                                    <h4>Thị Trường lớn</h4>
                                    <p>Thị trường ngách Sức khỏe và Làm đẹp đang phát triển mạnh mẽ nhờ xu hướng chăm sóc bản thân và lối sống lành mạnh. Sự gia tăng nhận thức về sức khỏe toàn diện và vẻ đẹp tự nhiên thúc đẩy nhu cầu các sản phẩm hữu cơ, an toàn. Công nghệ tiên tiến và các phương pháp làm đẹp không xâm lấn cũng đóng vai trò quan trọng, mặc dù thị trường này đối mặt với cạnh tranh khốc liệt và yêu cầu cao về chất lượng sản phẩm.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="selling-section section-b-space">
        <div class="container-fluid-lg">
            <div class="vendor-title">
                <h5>BẮT ĐẦU TRỞ THÀNH ĐỐI TÁC TƯ VẤN</h5>
                <p>Đăng ký ngay để trở thành đối tác tư vấn ngay hôm nay.</p>
            </div>
				...
				<div class="row">
                    ...
                    <div class="col-12">
                        <button class="btn btn-md mt-3 theme-bg-color text-white" id ="sendTask" onclick="sendTask()"><?php echo $appSession->getLang()->find("Start Selling");?></button>
                    </div>
