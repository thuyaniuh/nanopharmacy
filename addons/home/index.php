...
$hasHome = false;
?>
<section class="home-section-2 home-section-bg pt-25 overflow-hidden">
	<div class="container p-0">
		<div class="row">
			<!-- Sửa cột để responsive -->
			<div class="col-12">
				<div class="home-slide slider-animate">
					<?php for ($i = 0; $i < $dt_product_group->getRowCount(); $i++) {
					...
					?>
							<div class="col-12 col-md-6 col-lg-4">
								<div class="home-contain rounded-0 p-0" style="height:500px">
									<img src="<?php echo URL; ?>document/?id=<?php echo $document_id; ?>" class="bg-img blur-up lazyload" alt="">
									<div class="home-detail home-big-space p-center-left home-overlay position-relative">
										<div class="container-fluid-lg">
											<div>
												<h6 class="ls-expanded theme-color text-uppercase"><?php echo $name; ?></h6>
												<h5 class="text-content"><?php echo $content; ?></h5>
											</div>
										</div>
									</div>
								</div>
					...
					<div>
						<div class=" banner-contain-3 hover-effect">
							...
							<div class="banner-detail p-center-left w-75 banner-p-sm mend-auto">
								<div>
									<?php echo $content; ?>
									<button onclick="location.href = '<?php echo URL; ?><?php echo  $appSession->getTool()->validUrl($name); ?>/g-<?php echo $code; ?>';" class="btn shop-now-button mt-3 ps-0 mend-auto theme-color fw-bold"><?php echo $appSession->getLang()->find("Shop Now"); ?> <i class="fa-solid fa-chevron-right"></i></button>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-12">
				<div class="category-slider-1 arrow-slider wow fadeInUp">
					...
					?>
						<div>
							<div class="category-box-list" style="border-radius: 5%; overflow: hidden; display: flex; flex-direction: column; align-items: center; justify-content: space-between; min-height: 200px; height: 100%; text-align: center; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
								<div class="category-box-view" style="flex-grow: 1; width: 100%;">
									<a href="<?php echo URL; ?><?php echo $appSession->getTool()->validUrl($category_name); ?>/c-<?php echo $category_code; ?>">
										<img src="<?php echo URL; ?>document/?id=<?php echo $document_id; ?>" class="img-fluid blur-up lazyload" alt="<?php echo $category_name; ?>" style="width: 100%; height: auto; object-fit: cover; border-bottom: 1px solid #ddd;">
									</a>
								</div>
								<a href="<?php echo URL; ?><?php echo $appSession->getTool()->validUrl($category_name); ?>/c-<?php echo $category_code; ?>" class="category-name" style="width: 100%; padding: 10px; box-sizing: border-box; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
									<h4 style="margin: 0; font-size: 1.2em;"><?php echo $category_name; ?></h4>
									<h6><?php echo $appSession->getFormats()->getDOUBLE()->format($count); ?> <?php echo $appSession->getLang()->find("items"); ?></h6>
								</a>
								<div class="category-box-view" style="width: 100%; display: flex; justify-content: center; align-items: center; margin-bottom: 10px;">
									...
									<div class="product-box-4 wow fadeInUp" data-wow-delay="0.35s">
										<div class="product-image product-image-2">
											<a href="<?php echo URL; ?><?php echo  $appSession->getTool()->validUrl($name); ?>/p-<?php echo $price_code; ?>">
												<img src="<?php echo URL; ?>document/?id=<?php echo $document_id; ?>&h=105" class="img-fluid blur-up lazyload" alt="<?php echo $name; ?>">
											</a>
										...
										<div class="product-detail">
											...
											<h5 class="price theme-color"><?php echo $appSession->getCurrency()->format($currency_id, $unit_price); ?></span>
												<?php if ($old_price > 0) {
												?>
													<del><?php echo $appSession->getCurrency()->format($currency_id, $old_price); ?><?php } ?>
											</h5>
											<?php
											$sale_quantity = 0;
...
<section class="bank-section overflow-hidden">
	<div class="container">
		...
		<div class="slider-bank-3 arrow-slider slick-height row">
			<?php
			for ($ii = 0; $ii < $dt_product_group->getRowCount(); $ii++) {
					...
					<div class="col-4">
						<div class="bank-offer">
							<div class="bank-header">
								<div class="bank-left" style="width: 50%;">
								...
								<div class="bank-right" style="width: 50%; min-height:250px;">
							...
							<div class="bank-footer bank-footer-1">
								...
								<button type="button" class="bank-coupon btn" id="copyText" data-clipboard-action="copy" data-clipboard-target="#clipboardexample">Copy Code</button>
							</div>
						</div>
					</div>
			<?php
									...
									?>
										<div>
											<div class="product-image">
												<a href="<?php echo URL; ?><?php echo  $appSession->getTool()->validUrl($name); ?>/p-<?php echo $price_code; ?>">
													<img src="<?php echo URL; ?>document/?id=<?php echo $document_id; ?>" class="img-fluid product-image blur-up lazyload" alt="<?php echo $name; ?>">
												</a>
											...
											<div class="product-detail text-center">
												...
												<div class="timer timer-2 ms-0 my-4" id="clockdiv-1" data-hours="1" data-minutes="2" data-seconds="3">
													...
													<div class="product-box">
														...
														?>
															...
															<div class="product-image bg-white">
																<a href="<?php echo URL; ?><?php echo  $appSession->getTool()->validUrl($name); ?>/p-<?php echo $price_code; ?>">
																	<img src="<?php echo URL; ?>document/?id=<?php echo $document_id; ?>&h=147" class="img-fluid blur-up lazyload" alt="">
																</a>
					...
					<div class="col-lg-4">
						<div class="banner-contain-3 hover-effect" style="min-height: 100px;">
							...
							<div>
								...
								<div class="banner-detail banner-detail-2 text-dark p-center-left w-75 banner-p-sm position-relative mend-auto" style="min-height: 325px;">
									<div>
										<?php echo $content; ?>
										<button class="btn btn-md theme-bg-color text-white mt-sm-3 mt-1 fw-bold mend-auto" onclick="location.href = '<?php echo URL; ?><?php echo  $appSession->getTool()->validUrl($name); ?>/g-<?php echo $code; ?>';"><?php echo $appSession->getLang()->find("Shop Now"); ?></button>
									</div>
								</div>
							</div>
						</div>
...
?>
		<section class="product-section-4">
			<div class="container">
				...
				<div class="row">
					<div class="col-12 col-md-3 col-sm-12" style="background-image: url('<?php echo URL; ?>document/?id=<?php echo $document_id; ?>&h=200'); background-size: contain; background-repeat: no-repeat;" class="img-fluid blur-up lazyload" alt="<?php echo $name; ?>">
						<div class="banner-detail banner-detail-2 text-dark p-center-left w-75 banner-p-sm position-relative mend-auto">
							<div>
								<?php echo $content; ?>
								<button class="btn btn-md theme-bg-color text-white mt-sm-3 mt-1 fw-bold mend-auto" onclick="location.href = '<?php echo URL; ?><?php echo  $appSession->getTool()->validUrl($name); ?>/g-<?php echo $code; ?>';">
									<?php echo $appSession->getLang()->find("Shop Now"); ?>
								</button>
							</div>
						</div>
					</div>
					<div class="col-12 col-md-9 col-sm-12">
						<div class="row">
							<?php
							for ($i = 0; $i < min($productList->getRowCount(), 4); $i++) {
								$product_id = $productList->getString($i, "id");
								$code = $productList->getString($i, "code");
								$document_id = $productList->getString($i, "price_document_id");
								if ($document_id == "") {
									...
									<div class="product-box-4 wow fadeInUp" data-wow-delay="0.35s">
										<div class="product-image product-image-2">
											...
											<ul class="option">
												...
												<?php if ($appSession->getConfig()->getProperty("user_group_id") == "cfe1a96e-92e4-4f4b-ccba-93e03c915b1e") { ?>
													<li data-bs-toggle="tooltip" data-bs-placement="top" title="Seller">
														<a href="<?php echo URL; ?>seller_detail/?price_id=<?php echo $price_id; ?>" class="notifi-wishlist">
															<i data-feather="package"></i>
														</a>
										...
										<div class="product-detail">
											...
											?>
												<div class="add-to-cart-box">
													<button class="btn btn-add-cart addcart-button" onclick="addProduct('<?php echo $product_id; ?>', '<?php echo $currency_id; ?>', '<?php echo $unit_id; ?>', '<?php echo $attribute_id; ?>', 1, <?php echo $unit_price; ?>, '<?php echo $second_unit_id; ?>', <?php echo $factor; ?>, '', '<?php $company_id; ?>', '<?php echo $price_id; ?>','<?php echo $type_id; ?>', function(status, message){ loadCard(); })">
														<?php echo $appSession->getLang()->find("Add"); ?>
														<span class="add-icon">
															<i class="fa-solid fa-plus"></i>
														</span>
													</button>
...
<section class="blog-section">
	<div class="container">
		...
		<div class="slider-4-blog arrow-slider slick-height">
			<?php
			...
			<div class="col-12 col-md-6 col-lg-4 col-xl-3">
				<div class="service-contain-2">
					...
					<div class="service-detail">
						...
						<h6 class="text-content">An toàn trong giao dịch, trải nghiệm mua sắm thông minh.</h6>
					</div>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-4 col-xl-3">
				<div class="service-contain-2">
					...
					<div class="service-detail">
						<h3>Sản phẩm mới giảm giá</h3>
						<h6 class="text-content">Săn ngay sản phẩm mới cập nhật kho giảm giá nhất thị trường.</h6>
					</div>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-4 col-xl-3">
				<div class="service-contain-2">
					...
					<div class="service-detail">
						...
						<h6 class="text-content">Mua sắm an toàn với chính sách chất lượng uy tín nhất</h6>
					</div>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-4 col-xl-3">
				<div class="service-contain-2">
					...
					<div class="service-detail">
						...
						<h6 class="text-content">Miễn phí vận chuyển và thu hộ cho đơn hàng đạt tiêu chuẩn.</h6>
					</div>
				</div>
			</div>
		</div>
