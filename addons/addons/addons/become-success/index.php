        ...
        <div class="breadscrumb-contain breadscrumb-order">
          <div class="order-box">
            ...
            <div class="order-contain">
              <h3 class="theme-color"><?php echo $appSession->getLang()->find("Request Success"); ?></h3>
              <h5 class="text-content"><?php echo $appSession->getLang()->find("Thanks your register. We contact"); ?></h5>
