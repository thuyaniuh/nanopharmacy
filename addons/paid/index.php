    ...
    <div class="row">
      <div class="col-12 d-flex justify-content-between justify-content-md-end">
        <ul class="breadcrumb">
          ...
          <li><span>/</span></li>
          <li><?php echo $appSession->getLang()->find("Check Out"); ?></li>
        </ul>
      </div>
    </div>
  </div>
        ...
        <div class="breadscrumb-contain breadscrumb-order">
          <div class="order-box">
            ...
            <div class="order-contain">
              <h3 class="theme-color"><?php echo $appSession->getLang()->find("Order Success"); ?></h3>
              <h5 class="text-content"><?php echo $appSession->getLang()->find("Order Success MSG"); ?></h5>
              <div class="d-flex justify-content-center">
                <a href="<?php echo URL; ?>" class="btn btn-animation fw-bold p-2"><?php echo $appSession->getLang()->find("Continue Shop"); ?></a>
              </div>
            </div>
          </div>
        </div>
