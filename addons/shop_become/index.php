                        ...
                        <nav>
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item">
                                    <a href="<?php echo URL;?>shop_become/">
                                        <i class="fa-solid fa-house"></i>
                                    </a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Đối tác sản phẩm</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xxl-4 order-lg-2">
                    <div class="poster-box">
                        <div class="poster-image">
                            <img src="<?php echo URL;?>/assets/images/vendor-page/become-saller.svg" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-7">
                    <div class="seller-title h-100 d-flex align-items-center">
                        <div>
                            <h2>TRỞ THÀNH ĐỐI TÁC SẢN PHẨM TRÊN SIEUTHITPCN.VN</h2>
                            <p>Chúng tôi là một sàn thương mại điện tử với sứ mệnh mang lại những sản phẩm chất lượng cao, tập trung vào các ngách chiến lược như thực phẩm chức năng, mỹ phẩm và các sản phẩm làm đẹp. Chúng tôi nhận thấy đây là những lĩnh vực có tiềm năng phát triển mạnh mẽ và không ngừng gia tăng nhu cầu từ người tiêu dùng.</br></br>
Với kế hoạch kinh doanh đầy triển vọng, chúng tôi hiện đang có hơn 100.000 thành viên hoạt động sôi nổi trên sàn của mình. Đây chính là một lợi thế vượt trội để các đối tác có thể tiếp cận một lượng khách hàng lớn, tăng cường doanh số bán hàng và khẳng định thương hiệu của mình trên thị trường.</br></br>
Chúng tôi tự hào sở hữu hệ thống vận hành tối ưu, đảm bảo quy trình từ đăng ký sản phẩm, giao nhận hàng hóa đến dịch vụ khách hàng được thực hiện một cách nhanh chóng và chính xác. Nhờ vào hệ thống công nghệ tiên tiến, Quý đối tác sẽ tiết kiệm được chi phí quản lý và vận hành, đồng thời tăng hiệu quả kinh doanh.</br></br>
Ngoài ra, hợp tác với chúng tôi, Quý đối tác sẽ tiết kiệm được đáng kể chi phí quảng cáo. Chúng tôi có những chiến lược marketing hiệu quả, nhằm gia tăng sự hiện diện của sản phẩm trên các kênh truyền thông và tiếp cận đúng đối tượng khách hàng mục tiêu.
Chúng tôi tin tưởng rằng, sự hợp tác giữa chúng ta sẽ mang lại những giá trị thiết thực và lợi ích bền vững cho cả hai bên. Rất mong nhận được sự quan tâm và phản hồi từ Quý đối tác.<br><br>
</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="become-service section-b-space">
        <div class="container-fluid-lg">
            <div class="seller-title mb-5">
                <h2>TẠI SAO PHẢI ĐƯA HÀNG HÓA LÊN SIEUTHITPCN.VN ?</h2>
            </div>
            ...
            <div class="row">
                <div class="col-xxl-3">
                    <div class="service-box">
                        ...
                        <div class="service-detail">
                            <h4>Tiết kiệm được chi phí PR/Quảng cáo</h4>
                            <p>Khách hàng được tư vấn bởi những tư vấn viên am hiểu về sản phẩm, từ đó dễ dàng đưa ra quyết định mua hàng và tạo niềm tin, sự trung thành rất lớn.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-3">
                    <div class="service-box">
                        ...
                        <div class="service-detail">
                            <h4>Giúp doanh nghiệp kiểm soát tốt dòng tiên</h4>
                            <p>Chính sách đối soát tài chính linh hoạt nhanh gọn giúp nhà phát triển sản phẩm có thể chủ động về dòng tiền để tái đầu tư vào sản xuất kinh doanh.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-3">
                    <div class="service-box">
                        ...
                        <div class="service-detail">
                            <h4>Kết nối với cộng đồng tư vấn viên trên khắp 63 tỉnh thành</h4>
                            <p>Các tư vấn viên được đào tạo chuyên sâu về sản phẩm, kỹ năng bán hàng từ đó chi tiết về sản phẩm cho khách hàng, đặc biệt đối với những sản phẩm mới, chưa có độ nhận diện cao.
</p>
                        </div>
                    </div>
                </div>
			...
			c16.277-5.525,51.243-15.019,101.995-16.213V309.33z" />
                        ...
                        <div class="service-detail">
                            <h4>Dễ dàng tiếp cận</h4>
                            <p>Cộng đồng khách hàng được tiếp cận nền tảng dễ dàng với ngách sản phẩm chất lượng, giá tốt và chuyên nghiệp.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="business-section section-b-space">
        <div class="container-fluid-lg">
            <div class="vendor-title mb-5">
                <h5>KINH DOANH TẠI SIEUTHITPCN.VN THỰC SỰ DỄ DÀNG</h5>
            </div>
                        ...
                        <div class="business-box">
                            <div>
                                ...
                                <div class="business-detail">
                                    <h4>Liệt kê sản phẩm của bạn và nhận nhà cung cấp dịch vụ hỗ trợ</h4>
                                    <p>Đăng ký doanh nghiệp của bạn miễn phí và tạo một danh mục sản phẩm. Bán dưới nhãn hiệu riêng của bạn hoặc bán một thương hiệu hiện có. Hoàn thành tài liệu và lập danh mục của bạn một cách dễ dàng từ mạng Dịch vụ Chuyên nghiệp của chúng tôi.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-4">
                        <div class="business-box">
                            <div>
                                ...
                                <div class="business-detail">
                                    <h4>Nhận đơn hàng & Lên lịch nhận hàng</h4>
                                    <p>Sau khi được liệt kê, sản phẩm của bạn sẽ có sẵn cho hàng triệu người dùng. Nhận đơn đặt hàng và quản lý hoạt động kinh doanh trực tuyến của bạn thông qua Bảng điều khiển người bán và Ứng dụng di động Khu vực người bán của chúng tôi.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="business-box">
                            <div>
                                ...
                                <div class="business-detail">
                                    ...
                                    <p>Nhận thanh toán nhanh chóng và không rắc rối trong tài khoản của bạn sau khi đơn hàng của bạn được thực hiện. Mở rộng hoạt động kinh doanh của bạn với các khoản vay lãi suất thấp và không cần thế chấp.
</p>
                                </div>
                            </div>
                        </div>
    ...
    <section class="selling-section section-b-space">
        <div class="container-fluid-lg">
            <div class="vendor-title">
                <h5>BẮT ĐẦU TRỞ THÀNH NHÀ CUNG CẤP</h5>
                <p>Đối tác kinh doanh (Vendor) trên nền tảng SIEUTHITPCN.VN rất quan tâm đến uy tín, năng lực, tiềm lực của các đối tác cung cấp để lựa chọn hợp tác phân phối. Do đó bạn
hãy mô tả về doanh nghiệp của mình cố gắng làm nổi bật những lợi thế cạnh tranh của doanh nghiệp. Bán hàng trên SIEUTHITPCN.VN thật dễ dàng và hoàn toàn miễn phí. Tất cả những gì bạn cần là đăng ký, liệt kê danh mục và bắt đầu bán sản phẩm của mình.
</p>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="mt-3">
                            <div class="form-floating theme-form-floating-2 search-box">
                                ...
                                <label for="editname"><?php echo $appSession->getLang()->find("Name");?>:</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="mt-3">
                            <div class="form-floating theme-form-floating-2 search-box">
                                ...
                                <label for="editphone"><?php echo $appSession->getLang()->find("Phone");?>:</label>
                            </div>
                        </div>
                    </div>
                </div>
				<div class="row">
                    <div class="col-lg-6">
                        <div class="mt-3">
                            <div class="form-floating theme-form-floating-2 search-box">
                                <input type="text" class="form-control" id="editcommercial_name" placeholder="Commercial Name">
                                <label for="editcommercial_name"><?php echo $appSession->getLang()->find("Commercial Name");?>:</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="mt-3">
                            <div class="form-floating theme-form-floating-2 search-box">
                                ...
                                <label for="editphone"><?php echo $appSession->getLang()->find("Address");?>:</label>
                            </div>
                        </div>
                    </div>
                </div>
				<div class="row">
                    <div class="col-lg-4">
                        <div class="mt-3">
                            <div class="form-floating theme-form-floating-2 search-box">
                                <input type="text" class="form-control" id="edittax_code" placeholder="Mã số thuế">
                                <label for="edittax_code">Mã số thuế:</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="mt-3">
                            <div class="form-floating theme-form-floating-2 search-box">
                                <input type="text" class="form-control" id="editcontact_name" placeholder="Người liên hệ">
                                <label for="editcontact_name">Người liên hệ:</label>
                            </div>
                        </div>
                    </div>
					 <div class="col-lg-4">
                        <div class="mt-3">
                            <div class="form-floating theme-form-floating-2 search-box">
                                <input type="text" class="form-control" id="editcontact_mobile" placeholder="Số điện thoại">
                                <label for="editcontact_mobile">Số điện thoại:</label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="mt-3">
                            <div class="form-floating theme-form-floating-2 search-box">
                                ...
                                <label for="editemail"><?php echo $appSession->getLang()->find("Email");?>:</label>
                            </div>
                        </div>
                    </div>
				...
				<div class="row">
                    <div class="col-lg-12">
                        <div class="mt-3">
                            <div class="form-floating theme-form-floating-2 ">
                                <textarea  class="form-control" id="editdescription" maxLength="250" rows="4"></textarea>
                                <label for="editdescription"><?php echo $appSession->getLang()->find("Message");?>:</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <button class="btn btn-md mt-3 theme-bg-color text-white" id ="sendTask" onclick="sendTask()"><?php echo $appSession->getLang()->find("Start Vendor");?></button>
                    </div>
	...
	<script>
		document.querySelector('#editname').addEventListener('keyup', event => {
		   if (event.key !== "Enter") return;
		   document.getElementById('sendTask').click();
		   event.preventDefault();
		 });
		 document.querySelector('#editphone').addEventListener('keyup', event => {
		   if (event.key !== "Enter") return;
		   document.getElementById('sendTask').click();
		   event.preventDefault();
		 });
		 document.querySelector('#editemail').addEventListener('keyup', event => {
		   if (event.key !== "Enter") return;
		   document.getElementById('sendTask').click();
		   event.preventDefault();
		 });
		 ...
		 document.querySelector('#editdescription').addEventListener('keyup', event => {
		   if (event.key !== "Enter") return;
		   document.getElementById('sendTask').click();
		   event.preventDefault();
		 });
		  document.querySelector('#edittax_code').addEventListener('keyup', event => {
		   if (event.key !== "Enter") return;
		   document.getElementById('sendTask').click();
		   event.preventDefault();
		 });
		  document.querySelector('#editcontact_name').addEventListener('keyup', event => {
		   if (event.key !== "Enter") return;
		   document.getElementById('sendTask').click();
		   event.preventDefault();
		 });
		  document.querySelector('#editcontact_mobile').addEventListener('keyup', event => {
		   if (event.key !== "Enter") return;
		   document.getElementById('sendTask').click();
		   event.preventDefault();
		 });
		...
		function sendTask()
		{
			...
			if(ctr.value == '')
			{
				alert('<?php echo $appSession->getLang()->find("Please enter your name");?>');
				ctr.focus();
				return;
			}
			var name = ctr.value;
			...
			var ctr = document.getElementById('edittax_code');
			var tax_code = ctr.value;
			if(ctr.value == '')
			{
				alert('<?php echo $appSession->getLang()->find("Please enter tax code");?>');
				ctr.focus();
				return;
			}
			
			var ctr = document.getElementById('editcontact_name');
			var contact_name = ctr.value;
			if(ctr.value == '')
			{
				alert('<?php echo $appSession->getLang()->find("Please enter contact name");?>');
				ctr.focus();
				return;
			}
			var ctr = document.getElementById('editcontact_mobile');
			var contact_mobile = ctr.value;
			
			var ctr = document.getElementById('editemail');
			if(ctr.value == '')
			{
				alert('<?php echo $appSession->getLang()->find("Please enter your email");?>');
				ctr.focus();
				return;
			}
			var email = ctr.value;
			...
			if(ctr.value == '')
			{
				alert('<?php echo $appSession->getLang()->find("Please enter your password");?>');
				ctr.focus();
				return;
			}
			var password = ctr.value;
			name = name = "Become Vendor: " + name;
			
			ctr = document.getElementById('editcommercial_name');
			var commercial_name = ctr.value;
			...
			var description = "Phone: " + phone + "<br>";
			description = description + "Commercial Name: " + commercial_name + "<br>";
			description = description + "Address: " + address + "<br>";
			description = description + "Email: " + email + "<br>";
			description = description + "Mst: " + tax_code + "<br>";
			description = description + "Contact: " + contact_name + "<br>";
			description = description + "Mobile: " + contact_mobile + "<br>";
			description = description + "Password: " + password + "<br>";
			description = description + "Message: " + message + "<br>";
			var _url = "<?php echo URL;?>api/action/?ac=add_task&name=" + encodeURIComponent(name);
			_url = _url + "&description=" + encodeURIComponent(description);
			 ...
			 if (status === 0) {
				...
				{
					window.location.href="<?php echo URL;?>become-success/";
				}else{
					alert(message);
				}
