...
define('ID', 'VFSC');
define('META_TITLE', 'CÔNG TY CỔ PHẦN TẬP ĐOÀN DƯỢC NANO');
define('META_KEYWORD', 'CÔNG TY CỔ PHẦN TẬP ĐOÀN DƯỢC NANO');
define('META_DESCRIPTION', 'CÔNG TY CỔ PHẦN TẬP ĐOÀN DƯỢC NANO');
define('DB_HOST', '113.161.165.120');
define('DB_PORT', '5432');
define('DB_NAME', 'nanopharmacy_db');
define('DB_USER', 'postgres');
define('DB_PASSWORD', 'sieuthitpcn@1234567!');
define('LANGUAGE', 'vi');
define('COMPANY_ID', '9efb1515-f2ed-41d9-dd85-5d8d40fa4e87');
define('CURRENCY_ID', '23');
define('COMPANY_NAME', 'NANOPHARMACY');
define('COMPANY_LAT', '10.861177053727173');
define('COMPANY_LNG', '106.74004260552694');
define('CONTACT_EMAIL', 'info@nanopharmacy.vn');
define('CONTACT_TEL', '0785 873 618');
...
define('copyright', "All Rights Reserved by nanopharmacy.vn");
define('addons', "addons");
define('logo', "");
define('db_type', "postgresql");
define('developer', "0");
define('HOME', "home");
define('SUPPORT_EMAIL', "no-reply@nanopharmacy.vn");
define('DEFAULT_DOC_PATH', "");
if (!defined('ABSPATH')) {
	define('ABSPATH', dirname(__FILE__) . '/');
}

if (DEFAULT_DOC_PATH == "") {
	define("DOC_PATH", dirname(__FILE__) . "C:\\xampp\\htdocs\\nanopharmacy\\disk");
} else {
...
if ($appSession->getConfig()->getProperty("company_id") == "") {
